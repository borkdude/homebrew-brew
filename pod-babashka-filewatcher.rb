class PodBabashkaFilewatcher < Formula
  ...
  if OS.linux?
    url "https://github.com/borkdude/pod-babashka-filewatcher/releases/download/v0.0.1-SNAPSHOT/pod-babashka-filewatcher-0.0.1-SNAPSHOT-linux-amd64.zip"
    sha256 "087c7ee2b864803b3cbb09396b39d76df7f0ecf25ab2b29c564ca4026b866209"
  else
    url "https://github.com/borkdude/pod-babashka-filewatcher/releases/download/v0.0.1-SNAPSHOT/pod-babashka-filewatcher-0.0.1-SNAPSHOT-macos-amd64.zip"
